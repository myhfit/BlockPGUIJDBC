...
public class BPSQLActions
{
	...
	{
		return new Action[] { actconn, actdisconn, BPAction.separator(), BPAction.separator(), actrun, actresume, actresumetoend, actstop, BPAction.separator(), BPAction.separator(), actcommit, actrollback, BPAction.separator(), BPAction.separator(),
				actclone };
	}
}